...
; 0000 0045 // Clock value: Timer 1 Stopped
...
_0x3:
; 0000 0075       {
; 0000 0076       	PORTA = ~PORTA;
	IN   R30,0x1B
	COM  R30
	OUT  0x1B,R30
; 0000 0077          PORTB = ~PORTB;
	IN   R30,0x18
	COM  R30
	OUT  0x18,R30
; 0000 0078          PORTC = ~PORTC;
	IN   R30,0x15
	COM  R30
	OUT  0x15,R30
; 0000 0079          PORTD = ~PORTD;
	IN   R30,0x12
	COM  R30
	OUT  0x12,R30
; 0000 007A 
