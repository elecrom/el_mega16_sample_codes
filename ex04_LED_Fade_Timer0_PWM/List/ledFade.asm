...
; 0000 001B // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=In Func1=In Func0=In
; 0000 001C // State7=T State6=T State5=T State4=T State3=0 State2=T State1=T State0=T
...
; 0000 002E // Clock value: 16000.000 kHz
; 0000 002F // Mode: Phase correct PWM top=FFh
; 0000 0030 // OC0 output: Non-Inverted PWM
; 0000 0031 TCCR0=0x61;
	LDI  R30,LOW(97)
	OUT  0x33,R30
...
; 0000 0037 // Clock value: Timer 1 Stopped
...
; 0000 003D // Timer 1 Overflow Interrupt: Off
...
; 0000 004E // Clock value: Timer 2 Stopped
