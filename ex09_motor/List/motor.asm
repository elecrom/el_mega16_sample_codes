...
; 0000 0015 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0016 // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 001B // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 001C // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0022 // State7=T State6=T State5=T State4=T State3=T State2=P State1=P State0=P
...
; 0000 0028 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=In Func2=In Func1=In Func0=In
; 0000 0029 // State7=0 State6=0 State5=0 State4=0 State3=T State2=T State1=T State0=T
...
; 0000 0039 // Clock value: Timer 1 Stopped
; 0000 003A // Mode: Normal top=FFFFh
...
; 0000 003F // Timer 1 Overflow Interrupt: Off
...
_0x3:
; 0000 006A       {
; 0000 006B       //# Press SW0 to stop the motors
; 0000 006C 		if(PINC.2==0)
	SBIC 0x13,2
	RJMP _0x6
; 0000 006D 		{
; 0000 006E 		 	delay_ms(250);
	RCALL SUBOPT_0x0
; 0000 006F 
; 0000 0070 			PORTD.5=0;
	CBI  0x12,5
...
; 0000 0075 		}
; 0000 0076 
; 0000 0077       //# Press SW1 to start the motors in one direction
; 0000 0078 		else if(PINC.3==0)
	RJMP _0xF
_0x6:
	SBIC 0x13,3
	RJMP _0x10
...
; 0000 0081 		}
; 0000 0082 
; 0000 0083       //# Press SW2 to start the motors in reverse direction
; 0000 0084 		else if(PINC.4==0)
	RJMP _0x19
_0x10:
	SBIC 0x13,4
	RJMP _0x1A
